        ...
        <div class="customizer__single">
            ...
            <ul class="customizer-list d-flex layout">
                <li class="customizer-list__item">
                    <a href="{{ \App\Helpers\Helper::get_translation_url('en') }}" class="{{ ! \App\Helpers\Helper::is_rtl() ? 'active' : '' }}">
                        <img src="{{ asset('assets/img/ltr.png') }}" alt="">
                        <i class="fa fa-check-circle"></i>
                    </a>
                </li>
                <li class="customizer-list__item">
                    <a href="{{ \App\Helpers\Helper::get_translation_url( 'ar' ) }}" class="{{ \App\Helpers\Helper::is_rtl() ? 'active' : '' }}">
